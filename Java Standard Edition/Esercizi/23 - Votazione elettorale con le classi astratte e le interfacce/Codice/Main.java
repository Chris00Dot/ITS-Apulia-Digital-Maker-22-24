...
public class Main 
{
	public static void main(String[] args) 
	{
		...
		SchedaElettorale scheda1 = nina.vota(new Votazione(), Opzione.sceglieCosaVotare());
		
		Maggiorenne luigi = new Maggiorenne("Luigi");
		
		// VOTANTE 2
		Maggiorenne gianluca = new Maggiorenne("Gianluca");
		SchedaElettorale scheda2 = gianluca.vota(new Votazione(), Opzione.sceglieCosaVotare());
		...
		SchedaElettorale scheda3 = tommaso.vota(new Votazione(), Opzione.sceglieCosaVotare());
